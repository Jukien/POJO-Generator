...
public class POJOGeneratorConfigurable implements Configurable {
    ...
    public JComponent createComponent() {
        ...
        pojoGeneratorPanel.getIdClassAnnotationRadioButton().addItemListener(e -> {
            pojoGeneratorPanel.getHeaderEntityIdClassTextArea().setEnabled(isIdClassAnnotationEnabled());
        });
    ...
    public boolean isModified() {
        ...
        if (!pojoGeneratorPanel.getHeaderEntityIdClassTextArea().getText().equals(pojoGeneratorSettings.getHeaderEntityIdClass())) return true;
    ...
    public void apply() {
        ...
        pojoGeneratorSettings.setHeaderEntityIdClass(pojoGeneratorPanel.getHeaderEntityIdClassTextArea().getText());
        pojoGeneratorSettings.setHeaderDTO(pojoGeneratorPanel.getHeaderDTOTextArea().getText());
    }

    @Override
    public void reset() {
        pojoGeneratorPanel.getCapitalizeCheckBox().setSelected(pojoGeneratorSettings.getCapitalize());
        pojoGeneratorPanel.getGeneratedValueAnnotationsCheckBox().setSelected(pojoGeneratorSettings.getAutoGenerated());
        pojoGeneratorPanel.getManyToOneAndJoinColumnAnnotationsCheckBox().setSelected(pojoGeneratorSettings.getWithRelationshipAnnotations());
        pojoGeneratorPanel.getGenerateCompositePrimaryKeyCheckBox().setSelected(pojoGeneratorSettings.getGenerateCompositePrimaryKey());
        pojoGeneratorPanel.getIdClassAnnotationRadioButton().setSelected(pojoGeneratorSettings.getGenerateCompositePrimaryKeyWithIdClassAnnotation());
        ...
        pojoGeneratorPanel.getSuffixDTOTextField().setText(pojoGeneratorSettings.getSuffixDto());
        pojoGeneratorPanel.getAlwaysShowDifferencesBetweenFilesCheckBox().setSelected(pojoGeneratorSettings.getAlwaysShowDifferencesBetweenFiles());
        pojoGeneratorPanel.getHeaderEntityTextArea().setText(pojoGeneratorSettings.getHeaderEntity());
        pojoGeneratorPanel.getHeaderEntityIdClassTextArea().setText(pojoGeneratorSettings.getHeaderEntityIdClass());
        pojoGeneratorPanel.getHeaderDTOTextArea().setText(pojoGeneratorSettings.getHeaderDTO());
    }
    ...
    private boolean isIdClassAnnotationEnabled() {
        return pojoGeneratorPanel.getIdClassAnnotationRadioButton() != null && pojoGeneratorPanel.getIdClassAnnotationRadioButton().isSelected();
    }
    ...
    private void updateEnabled() {
        ...
        if (pojoGeneratorPanel.getHeaderEntityIdClassTextArea() != null) {
            pojoGeneratorPanel.getHeaderEntityIdClassTextArea().setEnabled(enabled && isIdClassAnnotationEnabled());
        }
    }
}
