...
public class POJOGeneratorConfigurable implements Configurable {
    ...
    public boolean isModified() {
        return (pojoGeneratorPanel.getCapitalizeCheckBox().isSelected() != pojoGeneratorSettings.getCapitalize()) ||
                (pojoGeneratorPanel.getSchemaAttributeCheckBox().isSelected() != pojoGeneratorSettings.getWithSchemaAttribute()) ||
                ...
                (pojoGeneratorPanel.getAlwaysShowDifferencesBetweenFilesCheckBox().isSelected() != pojoGeneratorSettings.getAlwaysShowDifferencesBetweenFiles());
    }
